    ...
    <Screen>
      ...
      {records.maxWeight ? (
        <section className="mt-6">
          ...
          {/*
            Четыре плитки, и две из них — «лучший подход» и «лучший результат»
            — без объяснения выглядят как одно и то же. Владелец так и
            спросил: не понял, как считается. Число, которое нечем проверить,
            не помогает, а раздражает.
          */}
          <p className="mt-2.5 px-1 text-[11.5px] leading-relaxed text-dim">
            «Лучший подход» — это вес × повторения, то есть сколько поднято за один подход.
            «Лучший результат» — прикидка разового максимума по формуле Эпли: вес × (1 +
            повторения ÷ 30). Она нужна, чтобы сравнивать несравнимое: 60 × 8 (80 кг) сильнее,
            чем 50 × 12 (70 кг), хотя вес меньше.
          </p>
        </section>
      ) : null}
