...
/**
 * The app's one chart shape: a single series, a soft fill, no chrome.
 * Deliberately plain — on a phone, a chart earns its place by showing
 * direction at a glance.
 *
 * Loaded on demand through `LineTrend`: the charting library is 358 KB, and
 * most of the app — the whole workout flow — never draws a chart.
 */
