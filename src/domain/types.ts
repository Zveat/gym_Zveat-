...
export interface BodyWeightLog {
  ...
  weight: number;
  /**
   * Процент жира с весов, 0…100.
   *
   * Вместе с весом этого достаточно: масса жира и сухая масса из них
   * считаются, а вводить руками то, что выводится, значит просить лишнюю
   * работу на каждом взвешивании. Проверено на настоящем отчёте весов:
   * 85,2 × 26,0% = 22,2 кг жира, 85,2 − 22,2 = 63 кг сухой массы — ровно те
   * числа, что показывают весы.
   */
  bodyFatPercent?: number | null;
  /**
   * Уровень висцерального жира по шкале весов — единственное здесь, что НЕ
   * выводится из веса и процента жира.
   */
