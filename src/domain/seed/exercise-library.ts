...
const SEED: SeedExercise[] = [
  ...
  },
  {
    ...
    /*
     * «(наклон)» и псевдонимы — со слов владельца: в выгрузке это упражнение
     * называется «Подьем гантелей на бицепс на наклонной скамье», и это оно
     * же. Раньше я завёл под это отдельное упражнение, опираясь на то, что
     * рядом в той же тренировке стоит ARM CURL с другим весом. Рядом стоит
     * действительно другое упражнение — но это тренажёрное сгибание, а данные
     * не могли сказать, каким из двух гантельных является наклонное.
     */
    name: 'Подъем гантелей сидя попеременно (наклон)',
    aliases: [
      'Подьем гантелей на бицепс на наклонной скамье',
